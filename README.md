...
### gLoad  滚动(可视范围内)触发加载 
  ...
  示例： http://wangpq.github.io/gome-frontend-develop-plugin/demo/滚动触发加载 gload.html
  
### floorTab 延时触发TAB  
  ...
  示例： http://wangpq.github.io/gome-frontend-develop-plugin/demo/延时触发TAB floorTab.html
...
### observer 自定义事件触发器
  ...
  示例： http://wangpq.github.io/gome-frontend-develop-plugin/demo/自定义事件触发器 observer.html
